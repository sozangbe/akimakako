...
class __TwigTemplate_acd0105226d48d67d068489055a0424d1a7bd37d8ae19ac105be85df75bb33ba extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_searched_customer_id_customer_widget($context, array $blocks = [])
    {
        ...
        // line 45
        echo "  ";
        $context["attr"] = twig_array_filter($this->env, ($context["attr"] ?? null), function ($__value__, $__key__) use ($context, $macros) { $context["value"] = $__value__; $context["key"] = $__key__; return (0 !== twig_compare(($context["key"] ?? null), "disabled")); });
        // line 46
        echo "  ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Catalog/Product/SpecificPrice/FormTheme/specific_price.html.twig", "C:\\wamp64\\www\\prestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Catalog\\Product\\SpecificPrice\\FormTheme\\specific_price.html.twig");
    }
}
