    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                73 => 'ps_facetedsearch',
                74 => 'ps_mbo',
                75 => 'ps_distributionapiclient',
                76 => 'ps_customeraccountlinks',
            ],
            ...
            'modules_translation_paths' => [
                ...
                68 => (\dirname(__DIR__, 4).'/modules/ps_customeraccountlinks/translations'),
            ],
